...
public class AmazonStepDefinitions {
    ...
    @And("{string} icin arma yapar")
    public void icinArmaYapar(String arg0) {
        amazonPage.searchbox.sendKeys(arg0);
    }

    @Then("sonucun {string} icerdigini test eder")
    public void sonucunIcerdiginiTestEder(String arg0) {
        Assert.assertTrue(amazonPage.sonucYaziElementi.getText().contains(arg0));
    }

    @And("kullanici sayfayi kapar")
    public void kullaniciSayfayiKapar() {
