...
public class D33_Data_Provider_Coklu {
    ...
    public static Object[][] kullaniciolustur() {
        String datas[][]={{"Manager","Manager"},{"Manager1","Manager1"},{"Manager2","Manager2"},{"Manager3","Manager3"}};
        return datas;
...
//{{"Manager","Manager"},{"Manager1","Manager1"},{"Manager2","Manager2"},{"Manager3","Manager3"}};
    ...
    public void test(String name, String password) {
        ...
        ckHotelsHomePage.userNameTextBox.sendKeys(name);
        ckHotelsHomePage.passwordTextBox.sendKeys(password);
